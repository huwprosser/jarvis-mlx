...
class FastTranscriber:
    def __init__(
        self, path_or_hf_repo: str = "mlx-community/whisper-tiny", **decode_options
    ):
        self.path_or_hf_repo = path_or_hf_repo
        self.dtype = mx.float16 if decode_options.get("fp16", True) else mx.float32
        self.model = ModelHolder.get_model(path_or_hf_repo, self.dtype)
